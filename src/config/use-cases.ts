...
export const useCasePages: readonly UseCasePage[] = [
  ...
  },
  {
    ...
    description: "パズル、アクション、反射神経、記憶力、経営・スポーツ・投資シミュレーションなど、登録・インストール不要でそのまま遊べる無料ブラウザゲームをまとめています。",
    intro: "短時間のミニゲームから、コンビニ経営・サッカークラブ経営・架空投資市場をじっくり遊ぶシミュレーションまで、スマホとPCの両方で楽しめます。",
    bullets: ["インストールなしですぐ遊びたい", "短時間ゲームとじっくり遊べるゲームを選びたい", "パズル・アクション・経営・スポーツ・資産運用ゲームを遊び分けたい"],
    toolIds: ["game-number-chain-10","game-lumo-sky-run","game-meteor-drift","game-flash-matrix","game-neon-snake","game-reaction-zero","game-orbit-catch","game-convenience-store-sim","game-football-club-sim","game-investment-sim"],
  },
  {
    slug: "office-work",
    label: "仕事の文書・時間を整理する",
