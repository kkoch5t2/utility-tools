...
export const useCasePages: readonly UseCasePage[] = [
  ...
  },
  {
    ...
    description: "数字パズル、横スクロールアクション、反射神経、記憶力、スネーク、タイミングゲームなど、登録・インストール不要でそのまま遊べる無料ブラウザゲームをまとめています。",
    intro: "1分で遊べるパズルから横スクロールアクション、隕石よけ、記憶力、スネーク、反応速度、1タップタイミングまで、スマホとPCの両方で遊べる軽量ゲームを集めています。",
    bullets: ["インストールなしですぐ遊びたい", "短時間の暇つぶしゲームを探している", "パズル・アクション・反射神経・記憶力・タイミングを遊び分けたい"],
    toolIds: ["game-number-chain-10","game-lumo-sky-run","game-meteor-drift","game-flash-matrix","game-neon-snake","game-reaction-zero","game-orbit-catch"],
  },
  {
    slug: "office-work",
    label: "仕事の文書・時間を整理する",
