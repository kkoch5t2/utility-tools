...
export const categoryMeta: CategoryMeta[] = [
  ...
  },
  {
    key: "game",
    label: "ゲーム",
    title: "無料ブラウザゲーム一覧｜インストール不要ですぐ遊べる",
    description: "登録・インストール不要で、スマホやPCのブラウザからすぐ遊べる軽量ゲーム一覧です。スコアやゲーム処理は原則ブラウザ内で完結します。",
    useCases: ["短時間で遊べる暇つぶしゲームを探している", "スマホでインストールせず遊びたい", "スコア更新を狙えるシンプルなゲームで遊びたい"],
  },
  {
    key: "share",
    label: "共有・調整",
