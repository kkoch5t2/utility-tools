...
export const categoryMeta: CategoryMeta[] = [
  ...
  },
  {
    key: "share",
    label: "共有・調整",
    title: "共有・調整ツール一覧｜日程調整・匿名投票・割り勘を無料で",
    description: "日程調整、匿名投票、出欠確認、割り勘・立替精算など、URLを共有して複数人で使える無料ツール一覧です。",
    useCases: ["複数人の日程や出欠をまとめたい", "共有URLで投票や多数決を取りたい", "旅行・飲み会の立替をまとめて精算したい"],
  },
];
