...
export const categoryMeta: CategoryMeta[] = [
  ...
  },
  {
    key: "japan",
    label: "日本向け",
    title: "日本向け便利ツール一覧｜郵便番号・電話番号・法人番号・学歴年を無料で",
    description: "郵便番号や電話番号の整形、住所正規化、都道府県コード、法人番号チェック、入学・卒業年度など、日本で使う事務・生活向けの無料ツール一覧です。",
    useCases: ["日本の住所・郵便番号・電話番号を整えたい", "都道府県コードや法人番号を確認したい", "履歴書用に入学・卒業年度をすぐ計算したい"],
  },
  {
    key: "office",
    label: "仕事・事務",
    title: "仕事・事務ツール一覧｜議事録・日報・稟議・残業集計を無料で",
    description: "議事録、日報、報告書、稟議書、メール件名、敬語変換、残業時間集計、時給・月給・年収換算など、日々の事務作業に使える無料ツール一覧です。",
    useCases: ["議事録・日報・報告書のたたき台を作りたい", "メール件名や敬語表現を整えたい", "残業時間や給与換算を手早く確認したい"],
  },
  {
    key: "share",
    label: "共有・調整",
