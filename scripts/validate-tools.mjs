...
const allowedFamilies = new Set(["image","csv","text","pdf","qr","video","developer","utility","utilityplus","csvmore","generalmore","special","security","japan","office"]);
const allowedCategories = new Set(["image","csv","json","text","pdf","qr","video","japanese","developer","date","calculator","share","security","japan","office"]);
